...
print(df_unique.head().to_markdown())
...
for batch in range(batches):
    ...
    df.merge(df_batch, left_on='dn', right_on='dn_none').drop(columns="dn_none").to_csv(Y_outpath, index=False)

    # df_batch.to_csv(Y_outpath, index=False)
