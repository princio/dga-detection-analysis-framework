...
\node [align=center, font=\small] at (7.5, -1.75) {window group\\with slide step 6};
\node[anchor=center,align=center] at (-1, 0.5) {malicious\\windows} ;
\node[anchor=center,align=center] at (-1, -0.75) {window\\pairs} ;
...
\node[] at (10.5, 0.5) {$m_{\alpha^m}$};
\node[anchor=center,align=center] at (-1, 1.5) {healthy\\windows};
...
\node[] at (8.5, 1.5) {$h_{2}$};
\node [align=center, font=\small] at (1.5, -1.75) {window group\\with slide step 0};
\node[anchor=center,align=center] at (-1, 0.5) {malicious\\windows} ;
\node[anchor=center,align=center] at (-1, -0.75) {window\\pairs} ;
\draw[fill=red!20] (0, 0) rectangle ++(1, 1);
\node[] at (0.5, 0.5) {$m_{0}$};
