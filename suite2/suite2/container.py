...
class Suite2Container(containers.DeclarativeContainer):
    ...
    dbdn_service = Singleton(DBDNService, db=db, nn_service=nn_service, lstm_service=lstm_service, psltrie_service=psltrie_service)
    message_service = Singleton(MessageService, db=db, dbdn_service=dbdn_service)
